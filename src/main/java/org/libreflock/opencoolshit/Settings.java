...
public class Settings {
    public static class Common {
        ...
        public Common(ForgeConfigSpec.Builder builder) {
            ...
            this.EEPROM_BLOCKSIZE = builder.comment("Block size of Flash").define("flash_block_size", 64);
            this.EEPROM_SIZE_TIER1 = builder.comment("Block capacity of PROM (Tier 1)").define("eeprom_size_2", 64);
